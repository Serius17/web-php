...
ORDER BY A.id_berita DESC LIMIT 0,5";
    ...
    ?>
    <!-- <font size=4><a href='berita_lengkap.php?id=$id_berita'>$judul</a></font><br>
    <small>Berita dikirimkan oleh <b>$pengirim</b> pada tanggal <b>$tanggal</b> dalam kategori <b>$kategori</b></small>
    <p>$headline</p>
    <hr> -->
</body>
